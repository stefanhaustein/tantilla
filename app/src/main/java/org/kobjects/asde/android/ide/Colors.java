 ...
 //   final int primaryMedium;
  ...
  // public static final int PRIMARY_LIGHT = 0xffeceff1;
    ...
    Colors(Context context, Theme theme) {
        ...
        //int primaryMedium = interpolate(background, primary); // darkMode ? 0xff222222 : 0xffdde3e6;
        primaryLight = interpolate(background, primary);
        accent = resolveColor(context, R.attr.colorAccent);
        accentLight = darkMode ?  0xffac1900 :  0xffff6659;
